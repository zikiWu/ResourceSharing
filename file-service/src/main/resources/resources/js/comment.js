...
function demo(curr,message4CommentId){
    ...
    $.getJSON(zuul.realpath + '/common/loadComment', {
...
function CommentCon(data, pid,pComment) {
    ...
    // 头像
    $("<div class='user-icon'><a href='" + fzqblog.realpath + "/user/" + data.userId + "'><img   src='" +  fzqblog.realpath + "/images/" + data.userIcon + "'></a></div>").appendTo(comment_panel);
...
function postPComment() {
    ...
    $.ajax({
	url : zuul.realpath + "/common/addComment",
	type: 'POST',
	dataType: 'json',
	data : {
	    content : content,
