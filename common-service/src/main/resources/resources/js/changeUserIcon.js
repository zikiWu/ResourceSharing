fzqblog.userIconUrl={
	saveCustomerUserIcon:zuul.realpath+"/common/saveUserIcon",
	saveSysUserIcon:zuul.realpath+"/common/saveSysUserIcon"
...
var uploader = WebUploader.create({
    ...
    // swf文件路径
    swf : zuul.realpath + '/common/webuploader/Uploader.swf',

    // 文件接收服务端。
    server : zuul.realpath + '/common/imageUpload2Temp.action',
...
function initSysUserIcon(){
	for(var i=1;i<=10;i++){
		...
		$("<img src="+fzqblog.realpath+"/images/default_usericon/"+i+".jpg>").appendTo(system_icon);
	}
